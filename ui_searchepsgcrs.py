...
#
# Created: Mon Oct 13 02:13:34 2014
...
class Ui_SearchEPSGCRS_dock(object):
    def setupUi(self, SearchEPSGCRS_dock):
        ...
        SearchEPSGCRS_dock.resize(294, 575)
        ...
        self.gridLayout.addWidget(self.txtCRS, 0, 1, 1, 1)
        ...
        self.comboCRS.addItem(_fromUtf8(""))
        self.comboCRS.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.comboCRS, 2, 1, 1, 1)
        ...
        self.txtFeedback.setAcceptRichText(False)
        self.txtFeedback.setObjectName(_fromUtf8("txtFeedback"))
        self.gridLayout.addWidget(self.txtFeedback, 4, 0, 1, 2)
    ...
    def retranslateUi(self, SearchEPSGCRS_dock):
        SearchEPSGCRS_dock.setWindowTitle(QtGui.QApplication.translate("SearchEPSGCRS_dock", "Search EPSG CRS", None, QtGui.QApplication.UnicodeUTF8))
